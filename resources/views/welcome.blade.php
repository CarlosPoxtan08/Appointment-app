    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <p class="mb-2 text-[#706f6c]">{{ config('app.name') }} has an incredibly rich ecosystem. <br>We suggest
            ...
            <div
                ...
                {{-- Application Logo --}}
                <div
                    class="w-full text-[#F53003] transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6 text-6xl font-bold text-center lg:text-left">
                    {{ config('app.name') }}
                </div>
