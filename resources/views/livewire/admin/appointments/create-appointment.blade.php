<div>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <p class="text-gray-500 mb-4 text-sm">Encuentra el horario perfecto para la cita.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
            <div class="md:col-span-1">
                ...
                <input type="date" id="date" wire:model.live="date" min="{{ \Carbon\Carbon::today()->format('Y-m-d') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
